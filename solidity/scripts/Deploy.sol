...
contract Deploy is Script {
  ...
  IERC20 public constant VESTING_TOKEN = IERC20(0xFE67A4450907459c3e1FFf623aA927dD4e28c67a);
  uint256 public constant START_TIME = 1_625_097_600;
  ...
  function run() public {
    ...
    require(address(VESTING_TOKEN) != address(0), 'VESTING_TOKEN');

    vm.startBroadcast(deployer);
    unlock = new Unlock(START_TIME, OWNER, VESTING_TOKEN, TOTAL_AMOUNT);
    vm.stopBroadcast();
    ...
    require(unlock.VESTING_TOKEN() == VESTING_TOKEN, 'VESTING_TOKEN');
  }
}
